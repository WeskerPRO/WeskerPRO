...
* 💻 **9+ Years of Engineering:** Specialized in managing massive codebases (80k+ lines)
* 🫁 **AI Research:** Focused on Deep Learning & Medical Imaging
...
| Domain | Tech |
| :--- | :--- |
| **Languages** | Python, Java, C++, SQL, Pawn |
| **AI / ML** | PyTorch, TensorFlow, CNNs, Computer Vision |
| **Systems** | Cloud Architecture (Azure), Docker, Git |
